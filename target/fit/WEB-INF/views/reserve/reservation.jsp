...
<div class="container">
	...
	<div>
		<form action="${ctx}/reserve/reservation" method="post" id="reserveForm">
		...
		if(fno == 'none'){
			...
			$.ajax({
				...
				success: function(result){
					...
					$('.imgDiv').empty();
					let str = result.fno > 5 ? "<img src='${ctx}/resources/img/premium.jpeg'/>" : "<img src='${ctx}/resources/img/standard.jpeg'/>";
					$('.imgDiv').prepend(str);
