...
<%@ include file="../includes/header.jsp" %>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
				...
				<form action="${ctx}/board/modify" method="post" class="modify">
				...
				<div class="form-group row">
					...
					<!-- 첨부파일 이미지 영역 끝 -->
					<div id="modify-btns">
						<button class="btn btn-primary btn-user" onclick="location.href='${ctx}/board/review?pageNum=${cri.pageNum}&amount=${cri.amount }&type=${cri.type}&keyword=${cri.keyword}'">목록</button>
	...
	$(document).ready(function(){
			...
			function showUploadResult(uploadResultArr){
				...
				$(uploadResultArr).each(function(i, obj){
					...
					+"<img src='${ctx}/display?fileName="+fileCallpath+"'/>"
